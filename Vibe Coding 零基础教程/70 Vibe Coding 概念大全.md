...
想学习编写提示词的实战技巧，可以看看鱼皮的免费《AI 编程教程》：[提示词编写技巧](/library/2010974716125712386)
...
💡 想要发现更多好用的 MCP 服务？可以访问 [鱼皮 AI 导航 - MCP 大全](/mcp)，持续更新优质 MCP，帮你重塑 AI 工作流。
...
💡 想要发现更多好用的 Agent Skills？可以访问 [鱼皮 AI 导航 - Skills 大全](/skills)，持续更新优质技能，让 AI 帮你干更多活。
